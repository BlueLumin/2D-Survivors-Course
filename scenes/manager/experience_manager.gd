...
func increment_experience(number : float):
	current_experience = min(current_experience + number, target_experience) # Like max(), it'll return which ever number is the lowest (so if experience goes above target_experience, then it'll return target experience).
